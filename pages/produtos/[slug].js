...
export default function Produto({produto}) {
    ...
    return (
        <>
            <Head>
                <title>{`Compre ${data.titulo} - Nobre Ave`}</title>
                <meta name="viewport" content="initial-scale=1.0, width=device-width" />
                <meta name="description" content={`Compre ${data.quantidade} ${data.titulo} das raças ${data.racas} `}/>
                <meta name="keywords" content="ovos de codorna, comprar, nobreave, codorna, fertilidade"></meta>
                <meta name="robots" content="index, follow" />
                <meta name="language" content="pt-BR" />
                <meta rel="canonical" href={`https://ovosdecodorna.com/produtos/${data.slug}`} />
                <meta property="og:title" content={data.titulo} />
                <meta property="og:type" content="product" />
                <meta property="og:url" content="https://ovosdecodorna.com/produtos" />
                <meta property="og:image" content={data.imagem[0].url} />
                <meta property="og:locale" content="pt_BR" />
                <meta property="og:site_name" content="Nobre Ave" />
                <meta property="og:description" content={`Compre ${data.quantidade} ${data.titulo} das raças ${data.racas} `} />
                <meta property="og:product.price:amount" content={data.preco} />
                <meta property="og:product.price:currency" content="BRL" />
                <meta property="og:product:availability" content="instock" />
                <meta property="og:product:plural_title" content={data.titulo} />
                <meta property="og:product:brand" content="Nobre Ave" />
            </Head>
            <div id="information">
                <main className="">
                    <Slider banners={data.imagem} produto/>
                    <div className="info">
