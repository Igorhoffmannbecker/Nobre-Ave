...
export default function Header({productsPage}) {
    ...
    <header>
      <menu>
        ...
        <form className="input" onSubmit={(e) => handldeInputSubmit(e)}>
          <input type="search" value={valueInput} onChange={e => setValueInput(e.target.value)} placeholder="Oque você está buscando"/>
          <button>
